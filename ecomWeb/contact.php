			...
			<div class="container">
				<div class="pull-left auto-width-left">
					<ul class="top-menu menu-beta l-inline">
						<li><a href=""><i class="fa fa-home"></i> 90-92 Le Van Luong,Thanh Xuan Ha Noi</a></li>
		...
		<div id="content" class="space-top-none">
			...
			<div class="row">
				<div class="col-sm-8">
					...
					<p>Nếu bạn có bất cứ thắc mắc nào đừng ngần ngại hãy liê hệ với chúng tôi chúng tôi với đội ngũ chuyên viên giàu kinh nghiệm giúp bạn giải quyết những khó khăn .chúng tôi sẽ trẻ lời đến Email của bạn mong bạn chú ý theo dõi email để có những lời giải đáp kịp thời.</p>
					<div class="space20">&nbsp;</div>
				...
				<div class="col-sm-4">
					...
					<p>
                        90-92 Le Van Luong,Thanh Xuan <br>
                        Ha Noi<br>
						Newyork
					</p>
					<div class="space20">&nbsp;</div>
