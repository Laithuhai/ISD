            ...
            <div class="history-slider">
                ...
                <div class="history-slides">
                    <div>
                        <div class="row">
                            <div class="col-sm-5">
                                <img class="pull-left" src="public/source/assets/dest/images/1.jpg" style="height:320px; width: 470px;
"alt="">                            </div>
                            <div class="col-sm-7">
                                <h5 class="other-title">Niềm Tin</h5>
                                <p>
                                    số 30 ,đường Lê Văn Lương<br />
                                    92 Croydon, NYC<br />
                                    New York
                                </p>
                                <div class="space20">&nbsp;</div>
                                <p>  Chúng tôi luôn lấy chữ tín lên hàng đầu . Những sản phẩm của của chúng tôi luôn chát lượng được bộ y tế cấp chứng nhận đảm bảo nguồn gốc rõ ràng .</p>
                            </div>
                        </div>
                    </div>
                    <div>
                        <div class="row">
                            <div class="col-sm-5">
                                <img class="pull-left" src="public/source/assets/dest/images/2.jpg" style="height:320px; width: 470px;
"alt="">
                            </div>
                            <div class="col-sm-7">
                                ...
                                <div class="space20">&nbsp;</div>
                                <p>Tiền thân chỉ với chỉ là tiệm thuốc nhỏ nhưng với sự tin tưởng của khách hàng chúng tôi đã mở thêm các chi nhánh trên cả nước và nhận được rất nhiều niềm tin của khác hàng đến để mua thuốc.</p>
                            </div>
                        </div>
                    </div>
                    <div>
                        <div class="row">
                            <div class="col-sm-5">
                                <img class="pull-left" src="public/source/assets/dest/images/p.jpg" style="height:320px; width: 470px;
"alt="">
                            </div>
                            <div class="col-sm-7">
                                <h5 class="other-title">Hợp Tác</h5>
                                <p>
                                    số 30 ,đường Lê Văn Lương<br />
                                    92 Croydon, NYC<br />
                                    New York
                                ...
                                <div class="space20">&nbsp;</div>
                                <p>chúng tôi hợp tác với nhiều các hãng thuốc trong và ngoài nước nên có mức giá phù hợp với những khách hàng đến với chúng tôi bạn sẽ được khám sơ qua như đo huyết áp miễn phí.</p>
                            </div>
                        </div>
                    </div>
                    <div>
...
"alt="">
        ...
        <h2 class="text-center wow fadeInDownwow fadeInDown">Chức Danh</h2>
        <div class="space20">&nbsp;</div>
        <h5 class="text-center other-title wow fadeInLeft">Những nhà sáng lập</h5>
        <p class="text-center wow fadeInRight">Hơn 30 trong lĩnh vực dược phẩm <br />đạt được nhiều bằng khen của nhà nước.</p>
        <div class="space20">&nbsp;</div>
        <div class="row">
            <div class="col-sm-6 wow fadeInLeft">
                <div class="beta-person media">

                    <img class="pull-left" src="public/source/assets/dest/images/bob.jpg" style="height:300px; width: 300px;
"alt="">

                    <div class="media-body beta-person-body">
                        <h5>Bob Robertson</h5>
                        <p class="font-large">Chủ Tịch Hội đòng quản trị</p>
                        <p> Tốt nghiệp loại giỏi khoa kinh tế tại trường đại học Havard là chuyên gia đầu ngành trong lĩnh vục kinh tế nên khi đến việt Nam ,ông đã thấy được cơ hội phát triển về thuốc tân duộc ỗng đã đầu tư cho lĩnh vực này.</p>
            ...
            <div class="col-sm-6 wow fadeInRight">
                <div class="beta-person media ">
                    ...
                    <img class="pull-left" src="public/source/assets/dest/images/tom.jpg"  style="height:300px; width: 300px;
" alt="">

                    <div class="media-body beta-person-body">
                        <h5>Mike Greenwood</h5>
                        <p class="font-large">Giám đốc bộ phân Marketing</p>
                        <p>Với hơn 10 năm làm trong lĩnh vực này nên ông có nhiều kinh nghiệm trong lĩnh vực marketing tất cả các chiến lược quảng cáo tạo dựng thương hiweuj không thể không kể đến tên của ông.</p>
                        <a href="single_type_gallery.html">View projects <i class="fa fa-chevron-right"></i></a>
                    </div>
                </div>
            </div>
        ...
        <p class="text-center wow fadeInUp">nhưng gương mặt sáng giá của công ty <br />giàu kinh nghiệm.</p>
        <div class="space20">&nbsp;</div>
        <div class="row">
            <div class="col-sm-3">
                <div class="beta-person beta-person-full">
                    <div class="bets-img-hover">
                        <img class="pull-left" src="public/source/assets/dest/images/dat.jpg" style="height:300px; width: 300px;
"alt="">                    </div>
...
" alt="">
            ...
            <div class="col-sm-3">
                <div class="beta-person beta-person-full">
                    <div class="bets-img-hover">
                        <img class="pull-left" src="public/source/assets/dest/images/toan.jpg" style="height:300px; width: 300px;
"alt="">                    </div>
                    <div class="beta-person-body">
                        <h5>David Black</h5>
                        <p class="font-large">Web developer</p>
